    ...
    <main className="px-4 py-16 sm:px-6 lg:px-8">
      ...
      <section className="mx-auto max-w-4xl">
        ...
        <p className="mt-6 text-lg leading-8 text-stone-650">
          ...
          agenda, dons, formulaires et informations pratiques.
        </p>
        <div className="mt-10 grid gap-5 md:grid-cols-2">
          {["Horaires et lieux de culte lisibles", "Pages sacrements orientées contact", "Informations locales cohérentes", "Parcours simple pour les visiteurs"].map((item) => (
            <div key={item} className="rounded-md border border-stone-200 bg-white p-5 shadow-sm">
              ...
              <p className="mt-3 leading-7 text-stone-650">
                Une information claire et stable aide les personnes à trouver la paroisse, préparer
                une démarche et contacter la bonne équipe.
              </p>
            </div>
          ))}
        </div>
