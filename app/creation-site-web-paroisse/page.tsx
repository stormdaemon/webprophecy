  ...
  return (
    <main className="px-4 py-16 sm:px-6 lg:px-8">
      <section className="mx-auto max-w-7xl">
        <p className="text-sm font-semibold uppercase tracking-[0.12em] text-gold-dark">SEO local</p>
        <h1 className="mt-4 text-4xl font-semibold text-ink sm:text-5xl">Création de site web pour paroisse, partout en France</h1>
